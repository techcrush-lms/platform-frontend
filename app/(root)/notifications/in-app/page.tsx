...
const InAppNotificationPage = () => {
  ...
  const [notificationTab, setNotificationTab] = React.useState<NotificationTab>(
    NotificationTab.ALL,
  );
            ...
            {instantNotificationLoading ? (
              ...
              <div className='flex flex-col items-center justify-center py-12 text-center'>
                <div className='w-16 h-16 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 mb-4'>
                  <span className='text-gray-400 dark:text-gray-300 text-3xl'>
                    🔔
                  </span>
                </div>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                  You don’t have any {notificationTab.toLowerCase()}{' '}
