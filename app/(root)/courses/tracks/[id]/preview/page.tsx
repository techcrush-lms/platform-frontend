    ...
    try {
      ...
      const msg =
        statusUpdate === ProductStatus.PUBLISHED
          ? 'Learning track published successfully!'
          : 'Learning track moved to draft successfully.';
      toast.success(msg);
    } catch (error) {
      // console.log(error);

      console.error('Publish error:', error);
      toast.error('Failed to publish learning track');
    }
  };
    ...
    <main className='min-h-screen'>
      <div className='section-container pb-4'>
        ...
        <section className='mt-4 mb-6'>
          <TrackProgressIndicator step={4} />
        </section>

        {loading ? (
          <div className='text-center py-10'>Loading track content...</div>
        ) : (
...
export default LearningTrackPreview;
