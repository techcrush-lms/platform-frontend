  ...
  return (
    <Suspense fallback={<div>Loading form...</div>}>
      <CreatePushFormContent
        ...
        handleDataListAppend={handleDataListAppend}
        handleDataListRemove={handleDataListRemove}
      />
    </Suspense>
  );
};

const CreatePushFormContent = ({
  count,
  dataList,
  setCount,
  setDataList,
            ...
            {dataList?.map((index: number) => (
              <div key={index} className='flex gap-2 mb-2'>
                <div className='flex-1'>
                  ...
                  <Input type='text' name='metadataKey' />
                </div>
                <div className='flex-1'>
                  <label
                    htmlFor='metadata'
                  ...
                  <Input type='text' name='metadataValue' />
                </div>
                {dataList[0] !== index && (
                  <HiMinus
